			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-list/Tiramisu.jpg" alt="">
						</div>
						<div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>Rp15.000</h2>
						<ul class="list">
							<li><a class="caregory.php" href="#"><span>Category</span> : Tart</a></li>
							<li><a href="category.php"><span>Availibility</span> : In Stock</a></li>
						</ul>
